    ...
    <Router>
      <div>
        <Switch>
          ...
          <PrivateRoute path="/admit_card/classes" component={StudentClassAdmitCard} exact />
          <PrivateRoute
          ...
          <PrivateRoute path="/teacher_salary" component={TeacherSalary} exact />
          ...
          <PrivateRoute path="/student-attendance" component={StudentAttendance} exact />
